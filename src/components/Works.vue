...
<template>
  ...
  <h2>このポートフォリオページ</h2>
  <p>
    バイト先とインターンシップでVue.jsを使う機会があってから，一度自分でゼロからSPAを構築してみようと思い，ポートフォリオサイト作成を兼ねて作りました．
  </p>
  <br />
  <p>
    まだ開発途中ですが，
    <a href="/portfolio/posts/ABC334-B-christmas-trees">記事</a>
    を見ることもできます．
    <br />
    .mdファイルをmarkedでHTMLに変換したものをページに反映させています．
  </p>
  <br />
  <h1>取り組んだこと</h1>
  <h2>Project Euler</h2>
  <p>
    ある複雑な性質を満たす数を求めて回答する，数学の問題集です．
